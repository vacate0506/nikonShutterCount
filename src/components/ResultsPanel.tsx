    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className={`flex justify-between gap-4 -mx-2 px-2 py-2 rounded-lg ${
            ...
            {exifData.shutterCount !== undefined ? (
              ...
              <span className="text-red-400 font-semibold text-right">未读取到快门次数</span>
            )}
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <span className="text-white/50">{showRawData ? '收起' : '展开'}</span>
        </div>
      </button>
